...
This script uses a pre-trained model, makes fuzzy membership predictions and computes the errors.
...
SiteList = 'F:\\UAV2SEN\\Results\\Experiments\\SiteList_exp3c.csv'#this has the lists of sites with name, month, year and 1s and 0s to identify training and validation sites
DataFolder = 'F:\\UAV2SEN\\FinalTif\\'  #location of processed tif files
ModelName = 'S_5_64_10B_exp3c'  #Name and location of the final model to be saved in DataFolder. Add .h5 extension
...
Ytop=6.5
SaveName='F:\\UAV2SEN\\Results\\Experiments\\blea.png'
OutDPI=1200
Fname='Arial'
Fsize=14
Fweight='bold'
...
X_train, X_test, y_train, y_test = train_test_split(TrainingTensor, TrainingLabels, test_size=0.1, random_state=int(42*np.random.random(1)))
